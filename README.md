...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 294a6963-8279-4ef4-9f3f-1100f2281271
```

> `294a6963-8279-4ef4-9f3f-1100f2281271` is the password of the certificate, you can change it to any password you want.

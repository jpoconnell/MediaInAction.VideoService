    ...
    private async Task CreateWebClientAsync()
    {
        ...
        if (webClient == null)
        {
            ...
            await AddOptionalClientScopesAsync(
                ...
                new List<string>
                {
                    "AdministrationService", "IdentityService", "EmbyService", "DelugeService", "FileService",
                    "VideoService", "TraktService", "CmskitService"
                }
            );
        }
    }
        ...
        if (swaggerClient == null)
        {
            ...
            await AddOptionalClientScopesAsync(
                ...
                new List<string>
                {
                    ...
                    "FileService", "VideoService", "TraktService", "CmskitService"
                }
            );
        }
    }

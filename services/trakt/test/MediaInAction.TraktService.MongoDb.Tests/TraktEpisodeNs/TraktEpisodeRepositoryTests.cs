...
public class TraktEpisodeRepositoryTests : TraktServiceMongoDbTestBase
{
    ...
    [Fact]
    public async Task Should_Query_One_TraktEpisode()
    {
        ...
        await WithUnitOfWorkAsync(async () =>
        {
                ...
                var traktEpisode = await (await _traktEpisodeRepository.GetMongoQueryableAsync())
                .FirstOrDefaultAsync();

                //Assert
                traktEpisode.ShouldNotBeNull();
        });
    }
}

...
public class TestData : ISingletonDependency
{
    ...
    public string Slug1 { get; set; } = "test-fbi";
    public string Slug2 { get; set; } = "test-law-and-order";
    public string Slug3 { get; set; } = "test-the-Lincoln-lawyer";
    public string Slug4 { get; set; } = "test-swat";
    ...
    public string MovieSlug1 { get; set; } = "test-fbi";
    public string MovieSlug2 { get; set; } = "test-law-and-order";
    public string MovieSlug3 { get; set; } = "test-the-Lincoln-lawyer";
    public string MovieSlug4 { get; set; } = "test-swat";

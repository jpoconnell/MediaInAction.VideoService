    ...
    public class TraktRequest : CreationAuditedAggregateRoot<Guid>, ISoftDelete
    {
        ...
        public virtual void SetAsCompleted()
        {
            ...
            AddDistributedEvent(new TraktRequestCompletedEto
            {
                ...
                Currency = Command,
                State = State,
                Seriess = Seriess.Select(MapSeriesToEto).ToList(),
        ...
        private static TraktRequestSeriesEto MapSeriesToEto(TraktRequestSeries product)
        {
            return new TraktRequestSeriesEto
            {
                Code = product.Code,
                Name = product.Name,

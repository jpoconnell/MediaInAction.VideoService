...
namespace MediaInAction.TraktService.Permissions
{
    public class TraktServicePermissionDefinitionProvider : PermissionDefinitionProvider
    {
        public override void Define(IPermissionDefinitionContext context)
        {
            ...
            shows.AddChild(TraktServicePermissions.TraktShow.Update, L("Permission:TraktShow.Update"));
            ...
            episodes.AddChild(TraktServicePermissions.TraktEpisode.Update, L("Permission:TraktEpisode.Update"));

...
public class EmbyProcessSyncJobs :  IEmbyProcessSyncJobs
{
    ...
    public List<EmbyActivityLogEntry> GetData()
    {
        ...
        var activityLogList = new List<EmbyActivityLogEntry>();
        try
        {
    ...
    private async Task UpdataDatabase(List<EmbyActivityLogEntry> activityList)
    {

...
using MediaInAction.EmbyService.EmbyShowNs.Specifications;
...
using EmbyShowCreateDto = MediaInAction.EmbyService.EmbyShowNs.EmbyShowCreateDto;
...
public class EmbyShowAppService : EmbyServiceAppService, IEmbyShowAppService
{
    ...
    public Task<EmbyShowDto> GetByShowNameYear(string show, int year)
    {

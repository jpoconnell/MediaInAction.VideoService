...
using MediaInAction.FileService.BG.FileMethodNs;
using MediaInAction.FileService.FileRequestsNs;
using MediaInAction.FileService.FileRequestsNs.Dtos;

namespace MediaInAction.FileService.BG.FileRequestNs;

public class FileRequestAppService : FileServiceBGAppService, IFileRequestAppService
{

...
namespace MediaInAction.VideoService.Functional.Test.SeriesNs;

public class CreateSeriesTests : BaseFunctionalTest
{
    public CreateSeriesTests(FunctionalWebApplicationFactory factory) : 
        base(factory)
    {
    }

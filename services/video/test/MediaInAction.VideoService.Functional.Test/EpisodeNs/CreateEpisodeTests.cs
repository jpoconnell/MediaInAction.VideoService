...
namespace MediaInAction.VideoService.Functional.Test.EpisodeNs;

public class CreateEpisodeTests : BaseFunctionalTest
{
    public CreateEpisodeTests(FunctionalWebApplicationFactory factory) : 
        base(factory)
    {
    }

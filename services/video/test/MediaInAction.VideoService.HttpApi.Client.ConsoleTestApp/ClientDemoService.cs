...
namespace MediaInAction.VideoService.HttpApi.Client.ConsoleTestApp
{
    public class ClientDemoService : ITransientDependency
    {
        ...
        private async Task TestWithHttpClientAndIdentityModelAuthenticationServiceAsync()
        {
            try 
            {
                ...
                var config1 = _configuration["IdentityClients:Default:Authority"];
                var config2 = _configuration["IdentityClients:Default:Scope"];
                var config3 = _configuration["IdentityClients:Default:ClientId"];
                var config4 = _configuration["IdentityClients:Default:ClientSecret"];
                var config5 = _configuration["IdentityClients:Default:GrantType"];
                var config6 = _configuration["IdentityClients:Default:UserName"];
                var config7 = _configuration["IdentityClients:Default:UserPassword"];
                ...
                using (var httpClient = new HttpClient())
                {
                    ...
                    var url = _configuration["RemoteServices:VideoService:BaseUrl"] +
                              "api/VideoService/sample/authorized";

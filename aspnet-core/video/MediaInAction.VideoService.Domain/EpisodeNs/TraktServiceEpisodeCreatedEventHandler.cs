...
public class TraktServiceEpisodeCreatedEventHandler : IDistributedEventHandler<TraktEpisodeCreatedEto>, ITransientDependency
{
    ...
    public async Task HandleEventAsync(TraktEpisodeCreatedEto eventData)
    {

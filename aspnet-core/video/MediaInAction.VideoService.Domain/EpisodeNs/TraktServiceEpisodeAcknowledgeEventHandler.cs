...
public class TraktServiceEpisodeAcknowledgeEventHandler : IDistributedEventHandler<TraktEpisodeAcknowledgeEto>, ITransientDependency
{
    ...
    public async Task HandleEventAsync(TraktEpisodeAcknowledgeEto eventData)
    {

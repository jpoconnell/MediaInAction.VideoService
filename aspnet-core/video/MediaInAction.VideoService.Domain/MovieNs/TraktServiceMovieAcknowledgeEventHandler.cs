...
public class TraktServiceMovieAcknowledgeEventHandler : IDistributedEventHandler<TraktMovieAcknowledgeEto>, ITransientDependency
{
    ...
    public async Task HandleEventAsync(TraktMovieAcknowledgeEto eventData)
    {

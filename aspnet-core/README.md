...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p e6cf451a-5817-4304-8caf-48057f496646
```

> `e6cf451a-5817-4304-8caf-48057f496646` is the password of the certificate, you can change it to any password you want.

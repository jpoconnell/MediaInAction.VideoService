    ...
    private async Task CreateWebClientAsync()
    {
        ...
        if (webClient == null)
        {
            ...
            await AddOptionalClientScopesAsync(
                ...
                new List<string>
                {
                    "AdministrationService", "IdentityService", "VideoService", "FileService",
                    "TraktService", "DelugeService", "EmbyService", "CmskitService"
                }
            );
        }
    }
    ...
    private async Task CreateSwaggerClientAsync()
    {
        ...
        if (swaggerClient == null)
        {
            ...
            await AddOptionalClientScopesAsync(
                ...
                new List<string>
                {
                    "AdministrationService", "IdentityService", "FileService", "VideoService",
                    "TraktService", "DelugeService", "EmbyService", "CmskitService"
                }
            );
        }

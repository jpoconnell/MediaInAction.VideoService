...
export const environment = {
  ...
  oAuthConfig: {
    ...
    clientId: 'Web',
    responseType: 'code',
    scope: 'offline_access openid profile email phone roles AdministrationService IdentityService BasketService FileService VideoService PaymentService CmskitService',
    //requireHttps: true,
  },
  apis: {
    default: {

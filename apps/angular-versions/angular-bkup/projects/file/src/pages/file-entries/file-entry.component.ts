...
import { FileEntryDto } from '../../lib/proxy/file-service/file-entry-ns/models';
import { FileEntryService } from '../../lib/proxy/file-service/file-entry-ns/file-entry.service';
...
export class FileEntryComponent implements OnInit {
  ...
  buildForm() {
    this.form = this.fb.group({
      name: [this.selected.filename, { validators: [Validators.required] }],
